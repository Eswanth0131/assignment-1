...
used to ingest the material into text files and sort them: ingest_pds.py, ingest_website.py, ingest_yt.py,
and sort.py.
...
graph. This information builds context of the question and the actual question is sent to qwen2.5 via Ollama,
which provides an answer using the graph context provided. For the subgraphs and other information about the
3 questions please refer to m4_subgraphs.jsonl. For the screenshots of the 3 queries and responses, please
refer to the images q1, q2, and q3.
